...
<header>
    ...
    <nav>
    <ul>
        <c:if test="${not empty user && sessionScope.user.roles[0].title != 'admin'}">
            <li class="nav-left"><a href="${pageContext.request.contextPath}/baskets/user/${user.id}">Корзина</a></li>
            <c:if test="${sessionScope.user.roles[0].title == 'admin'}">
                <li class="nav-left"><a href="${pageContext.request.contextPath}/products/all">Список товаров</a></li>
                <li class="nav-left"><a href="${pageContext.request.contextPath}/users/all">Список пользователей</a></li>
            </c:if>
        </c:if>
        <c:if test="${sessionScope.user.roles[0].title == 'admin'}">
                <li class="nav-left"><a href="${pageContext.request.contextPath}/products/all">Список товаров</a></li>
                <li class="nav-left"><a href="${pageContext.request.contextPath}/products/add">Добавить товар</a></li>
                <li class="nav-left"><a href="${pageContext.request.contextPath}/users/all">Список пользователей</a></li>
            </c:if>
        ...
        <c:if test="${empty user}">
            <li class="nav-right"><a href="${pageContext.request.contextPath}/users/register">Зарегистрироваться</a></li>
        </c:if>
    </ul>
</nav>
            ...
            <div class="product-grid">
                <c:forEach var="product" items="${products}">
                    <div class="product-card">
                        <img src="${pageContext.request.contextPath}/resources/images/${product.picture}" 
